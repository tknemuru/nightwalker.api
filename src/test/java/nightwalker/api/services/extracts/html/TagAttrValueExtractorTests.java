...
public class TagAttrValueExtractorTests {

    /**
     * 単一行の指定したタグから、アトリビュート値が抽出できることをテストします。
     * @throws Exception
     */
    @Test
    public void 単一行の指定したタグからアトリビュート値が抽出できる() throws Exception {
        TagAttrValueExtractor extractor = new TagAttrValueExtractor("img", "src");
    ...
    /**
     * 複数行の指定したタグから、アトリビュート値が抽出できることをテストします。
     * @throws Exception
     */
    @Test
    public void 複数行の指定したタグからアトリビュート値が抽出できる() throws Exception {
        TagAttrValueExtractor extractor = new TagAttrValueExtractor("img", "src");
    ...
    /**
     * 指定したタグが0件でも例外が発生せず、正常に終了することをテストします。
     * @throws Exception
     */
    @Test
    public void 指定したタグが0件でも正常に終了する() throws Exception {
        TagAttrValueExtractor extractor = new TagAttrValueExtractor("img", "src");
        StringBuilder resources = new StringBuilder();
        resources.append("<iframe class=\"thumbnail-image\" src=\"/iframes/assets/ninja.html\"></iframe>");
